...
def get_latest_satellite_image(lat, lon):
    """Fetches the latest cloud-free Sentinel-2 image for given coordinates."""
...
def download_image(image, point, filename):
    """Downloads the satellite image and saves it as a file in APIphotos/."""
    ...
    if response.status_code == 200:
        ...
        os.system(f"xdg-open {file_path}")  # Use this on Linux
        # os.startfile(file_path)  # Uncomment this if using Windows
    else:
